    ...
    <div>
      <h2 id="author-heading">
        ...
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          ...
          &nbsp;
          <Translate contentKey="kacetalLibraryGatewayApp.kacetalLibraryBookAuthor.home.createLabel">Create new Author</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {authorList && authorList.length > 0 ? (
          ...
          <div className="alert alert-warning">
            <Translate contentKey="kacetalLibraryGatewayApp.kacetalLibraryBookAuthor.home.notFound">No Authors found</Translate>
          </div>
        )}
      </div>
