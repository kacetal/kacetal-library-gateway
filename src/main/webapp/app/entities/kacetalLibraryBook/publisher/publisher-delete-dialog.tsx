...
import {deleteEntity, getEntity} from './publisher.reducer';
...
export const PublisherDeleteDialog = (props: IPublisherDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="kacetalLibraryGatewayApp.kacetalLibraryBookPublisher.delete.question">
        <Translate
          contentKey="kacetalLibraryGatewayApp.kacetalLibraryBookPublisher.delete.question"
          interpolate={{id: publisherEntity.id}}
        >
