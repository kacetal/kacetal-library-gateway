    ...
    <div>
      <h2 id="book-heading">
        ...
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          ...
          &nbsp;
          <Translate contentKey="kacetalLibraryGatewayApp.kacetalLibraryBookBook.home.createLabel">Create new Book</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {bookList && bookList.length > 0 ? (
          ...
          <div className="alert alert-warning">
            <Translate contentKey="kacetalLibraryGatewayApp.kacetalLibraryBookBook.home.notFound">No Books found</Translate>
          </div>
        )}
      </div>
