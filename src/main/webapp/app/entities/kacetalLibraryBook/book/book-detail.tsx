  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate
            contentKey="kacetalLibraryGatewayApp.kacetalLibraryBookBook.detail.title">Book</Translate> [<b>{bookEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="publishDate">
              <Translate
                contentKey="kacetalLibraryGatewayApp.kacetalLibraryBookBook.publishDate">Publish Date</Translate>
            </span>
          </dt>
          <dd>
            ...
            {bookEntity.cover ? (
              <div>
                <a onClick={openFile(bookEntity.coverContentType, bookEntity.cover)}>
                  <img src={`data:${bookEntity.coverContentType};base64,${bookEntity.cover}`}
