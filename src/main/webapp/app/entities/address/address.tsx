            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('zipCode')}>
                  <Translate contentKey="kacetalLibraryGatewayApp.address.zipCode">Zip Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('city')}>
                  <Translate contentKey="kacetalLibraryGatewayApp.address.city">City</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('country')}>
                  <Translate contentKey="kacetalLibraryGatewayApp.address.country">Country</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
