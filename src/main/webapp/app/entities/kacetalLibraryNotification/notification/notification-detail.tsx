  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate
            contentKey="kacetalLibraryGatewayApp.kacetalLibraryNotificationNotification.detail.title">Notification</Translate> [
        ...
        <dl className="jh-entity-details">
          <dt>
            <span id="sentDate">
              <Translate
                contentKey="kacetalLibraryGatewayApp.kacetalLibraryNotificationNotification.sentDate">Sent Date</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="userId">
              <Translate
                contentKey="kacetalLibraryGatewayApp.kacetalLibraryNotificationNotification.userId">User Id</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="bookId">
              <Translate
                contentKey="kacetalLibraryGatewayApp.kacetalLibraryNotificationNotification.bookId">Book Id</Translate>
            </span>
          </dt>
          <dd>{notificationEntity.bookId}</dd>
        </dl>
