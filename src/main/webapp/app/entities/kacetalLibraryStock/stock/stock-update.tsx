  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="kacetalLibraryGatewayApp.kacetalLibraryStockStock.home.createOrEditLabel">
            <Translate contentKey="kacetalLibraryGatewayApp.kacetalLibraryStockStock.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : stockEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="stock-name">
