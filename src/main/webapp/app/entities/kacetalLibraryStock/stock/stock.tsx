    ...
    <div>
      <h2 id="stock-heading">
        ...
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          ...
          &nbsp;
          <Translate contentKey="kacetalLibraryGatewayApp.kacetalLibraryStockStock.home.createLabel">Create new Stock</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {stockList && stockList.length > 0 ? (
          ...
          <div className="alert alert-warning">
            <Translate contentKey="kacetalLibraryGatewayApp.kacetalLibraryStockStock.home.notFound">No Stocks found</Translate>
          </div>
        )}
      </div>
