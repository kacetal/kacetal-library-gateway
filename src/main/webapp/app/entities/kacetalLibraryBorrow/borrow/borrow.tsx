    ...
    <div>
      <h2 id="borrow-heading">
        ...
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          ...
          &nbsp;
          <Translate contentKey="kacetalLibraryGatewayApp.kacetalLibraryBorrowBorrow.home.createLabel">Create new Borrow</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {borrowList && borrowList.length > 0 ? (
          ...
          <div className="alert alert-warning">
            <Translate contentKey="kacetalLibraryGatewayApp.kacetalLibraryBorrowBorrow.home.notFound">No Borrows found</Translate>
          </div>
        )}
      </div>
