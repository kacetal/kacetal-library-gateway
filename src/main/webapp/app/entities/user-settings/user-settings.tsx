    ...
    <div>
      <h2 id="user-settings-heading">
        ...
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          ...
          &nbsp;
          <Translate contentKey="kacetalLibraryGatewayApp.userSettings.home.createLabel">Create new User Settings</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {userSettingsList && userSettingsList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('avatar')}>
                  <Translate contentKey="kacetalLibraryGatewayApp.userSettings.avatar">Avatar</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th>
                  <Translate contentKey="kacetalLibraryGatewayApp.userSettings.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
                    ...
                    {userSettings.avatar ? (
                      <div>
                        <a onClick={openFile(userSettings.avatarContentType, userSettings.avatar)}>
                          <img src={`data:${userSettings.avatarContentType};base64,${userSettings.avatar}`} style={{ maxHeight: '30px' }} />
                          &nbsp;
                        </a>
                        <span>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="kacetalLibraryGatewayApp.userSettings.home.notFound">No User Settings found</Translate>
          </div>
        )}
      </div>
