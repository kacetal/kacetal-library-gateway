...
import author, {
  AuthorState
} from 'app/entities/kacetalLibraryBook/author/author.reducer';
// prettier-ignore
import publisher, {
  PublisherState
} from 'app/entities/kacetalLibraryBook/publisher/publisher.reducer';
// prettier-ignore
import stock, {
  StockState
} from 'app/entities/kacetalLibraryStock/stock/stock.reducer';
// prettier-ignore
import notification, {
  NotificationState
} from 'app/entities/kacetalLibraryNotification/notification/notification.reducer';
