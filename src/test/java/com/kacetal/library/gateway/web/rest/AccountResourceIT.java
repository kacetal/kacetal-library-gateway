...
import com.kacetal.library.gateway.config.Constants;
import com.kacetal.library.gateway.domain.Authority;
import com.kacetal.library.gateway.domain.User;
import com.kacetal.library.gateway.repository.AuthorityRepository;
import com.kacetal.library.gateway.repository.UserRepository;
import com.kacetal.library.gateway.security.AuthoritiesConstants;
import com.kacetal.library.gateway.service.MailService;
import com.kacetal.library.gateway.service.UserService;
import com.kacetal.library.gateway.service.dto.PasswordChangeDTO;
...
import com.kacetal.library.gateway.web.rest.vm.KeyAndPasswordVM;
import com.kacetal.library.gateway.web.rest.vm.ManagedUserVM;
...
public class AccountResourceIT {
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        user.setImageUrl("https://placehold.it/50x50");
        user.setLangKey("en");
        ...
        restUserMockMvc.perform(get("/api/account")
            ...
            .andExpect(jsonPath("$.imageUrl").value("https://placehold.it/50x50"))
    ...
    public void testRegisterValid() throws Exception {
        ...
        validUser.setImageUrl("https://placehold.it/50x50");
    ...
    public void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setImageUrl("https://placehold.it/50x50");
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setImageUrl("https://placehold.it/50x50");
    ...
    public void testSaveAccount() throws Exception {
        ...
        userDTO.setImageUrl("https://placehold.it/50x50");
